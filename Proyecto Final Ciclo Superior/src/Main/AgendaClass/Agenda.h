  ...
  */
  ...
  Contact Contacto1 =
      Contact(CONTACTO1_ID, CONTACTO1_NOMBRE, CONTACTO1_APELLIDO,
              CONTACTO1_CORREO, CONTACTO1_TELEFONO, CONTACTO1_STATUS);
  Contact Contacto2 =
      Contact(CONTACTO2_ID, CONTACTO2_NOMBRE, CONTACTO2_APELLIDO,
              CONTACTO2_CORREO, CONTACTO2_TELEFONO, CONTACTO2_STATUS);
  Contact Contacto3 =
      Contact(CONTACTO3_ID, CONTACTO3_NOMBRE, CONTACTO3_APELLIDO,
              CONTACTO3_CORREO, CONTACTO3_TELEFONO, CONTACTO3_STATUS);
  Contact Contacto4 =
      Contact(CONTACTO4_ID, CONTACTO4_NOMBRE, CONTACTO4_APELLIDO,
              CONTACTO4_CORREO, CONTACTO4_TELEFONO, CONTACTO4_STATUS);
