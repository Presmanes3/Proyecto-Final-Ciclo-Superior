...
CustomDHTClass::CustomDHTClass(TimeManager* timeManager, Timer* checkTimer,
...
void CustomDHTClass::updateHumidity( ) {
...
float CustomDHTClass::getTemperature( ) { return this->Temperature; }
float CustomDHTClass::getHumidity( ) { return this->Humidity; }
float CustomDHTClass::getHeat( ) { return this->Heat; }

BasicDHTFrame* CustomDHTClass::getBasicFrame( ) { return &this->basicFrame; }
